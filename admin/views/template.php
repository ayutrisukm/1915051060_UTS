    ...
    <div class="container ">
        ...
        <div class="content" >
              <ul class="list-group col-md-3 col-xs-2">
                <li class="list-group-item "><a href="http://localhost/laundry/admin/index.php?mod=laundry"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Data Laundry</span></a></li>
                <li class="list-group-item "><a href="http://localhost/laundry/admin/index.php?mod=data"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Data Pelanggan</span></a></li>
                </ul>
